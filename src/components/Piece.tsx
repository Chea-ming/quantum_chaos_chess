...
const Piece: React.FC<PieceProps> = ({ piece, probability = 1.0 }) => {
    const upperSymbol = piece.toUpperCase()
    const isWhite = piece === upperSymbol

    // Cyberpunk/esports colors - neon cyan for white, bright magenta for black
    const fillColor = isWhite ? "#00e5ff" : "#FF40A0"
    const strokeColor = isWhite ? "#00ffff" : "#FF80C0"
